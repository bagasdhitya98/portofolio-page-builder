          ...
          <div key={index} className="mb-4 grid grid-cols-2 gap-x-20">
            ...
            <div className="mx-auto">
              ...
              <textarea
                ...
                className={`bg-gray-100 w-full h-96 appearance-none border-2 border-gray-100 rounded w-full my-5 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 ${
                  formik.submitCount > 0 &&
                  formik.errors.list_portofolio &&
